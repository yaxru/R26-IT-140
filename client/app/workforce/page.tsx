    ...
    return (
      <div className="bg-white dark:bg-[#111113] border-2 border-zinc-800 p-4 text-center w-64 break-inside-avoid mb-6 rounded-none shadow-sm">
        ...
        <div className="bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-900/60 p-2 mb-3 rounded-none">
          <p className="text-[10px] text-emerald-700 dark:text-emerald-400 font-mono uppercase">
            PIN (Keep Secret)
          </p>
        ...
        <div className="grid grid-cols-2 gap-1.5 print:hidden">
          ...
          {worker.phoneNumber ? (
            ...
            <button
              disabled
              className="px-2 py-1.5 bg-zinc-100 dark:bg-zinc-800 text-zinc-400 text-[11px] font-medium rounded-none opacity-50 cursor-not-allowed border border-zinc-200 dark:border-zinc-700"
            >
              No Phone
            </button>
          )}
  ...
  return (
    <div className="flex flex-col h-full p-6 gap-6">
          ...
          <div className="space-y-4">
            ...
            {previewData.length > 0 && !showImportModal && (
              <div className="flex items-center justify-between bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-900/30 p-3 rounded-none text-sm">
                <div>
                  <p className="text-blue-700 dark:text-blue-400 font-medium text-xs">
                    ✓ {previewData.length} worker(s) ready to import
                  </p>
                </div>
                <button
                  onClick={() => setShowImportModal(true)}
                  className="px-3 py-1.5 bg-blue-600 text-white text-xs rounded-none hover:bg-blue-700 font-medium"
                >
                  Review Data
                </button>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="font-mono text-xs text-zinc-600 dark:text-zinc-400 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-2 rounded-none space-y-1">
                <p>Yasiru, 4092, LINE-A, overlock, B, 0771234567, y@mail.com</p>
                <p>Kasun, 5092, LINE-B, flatlock, A, , k@mail.com</p>
              </div>
            </div>
            <p className="text-[11px] text-zinc-500 dark:text-zinc-500 leading-relaxed border-t border-zinc-200 dark:border-zinc-800 pt-3">
              ...
              automatically batched to bypass system rate limits.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-[#111113] border border-zinc-200 dark:border-zinc-800/60 p-6 rounded-none">
          ...
          {importResult.failed.length > 0 && (
            <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/50 p-4 rounded-none mb-6">
              <p className="text-xs font-mono text-red-600 uppercase mb-3 font-bold">
                Failed Records
              </p>
          ...
          {importResult.success.length > 0 && (
            <div>
              <div className="flex items-center justify-between mb-4 border-t border-zinc-200 dark:border-zinc-800 pt-6">
                <p className="text-xs font-mono text-zinc-900 dark:text-zinc-100 uppercase font-bold">
                  Generated Credentials
                </p>
                <button
                  onClick={() => window.print()}
                  className="px-4 py-2 bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900 text-xs font-medium rounded-none transition-colors"
                >
                  Print All
                </button>
              </div>
                      ...
                      {totalPages > 1 && (
                        <div className="flex items-center gap-2 print:hidden">
                          <button
                            ...
                            disabled={page === 1}
                            className="px-2 py-1 text-xs bg-zinc-100 dark:bg-zinc-800 disabled:opacity-50 rounded-none border border-zinc-200 dark:border-zinc-700"
                          >
                            Prev
                          </button>
      ...
      <div className="bg-white dark:bg-[#111113] border border-zinc-200 dark:border-zinc-800/60 p-6 rounded-none">
        ...
        {/* Table Rendering */}
        {fetchingWorkers ? (
          <div className="py-12 text-center text-xs text-zinc-500 animate-pulse font-mono uppercase tracking-widest">
            Loading Records...
          </div>
        ) : existingWorkers.length === 0 ? (
          <div className="py-12 text-center text-xs text-zinc-500 border border-dashed border-zinc-200 dark:border-zinc-800 rounded-none">
            ...
            <div className="p-6 overflow-y-auto flex-1 bg-zinc-50 dark:bg-zinc-900/30">
              {Object.keys(groupedWorkers).length === 0 ? (
                ...
                Object.entries(groupedWorkers).map(([line, workers]) => (
                  <div
                    key={line}
                    className="mb-8 border border-zinc-200 dark:border-zinc-800/60 bg-white dark:bg-[#111113] overflow-hidden rounded-none"
                  >
                        ...
                        <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800/40">
                          {workers.map((w) => (
                            ...
                            >
                              ...
                              <td className="px-6 py-3 font-mono text-zinc-600 dark:text-zinc-400">
                                {w.workerId}
                              </td>
                              <td className="px-6 py-3 font-mono text-zinc-600 dark:text-zinc-400">
                                {w.phoneNumber || "-"}
